...
research1 = Assignment.create(name: "Research", teacher: snape , student: harry)
research2 = Assignment.create(name: "Research", teacher: snape , student: hermione)
research3 = Assignment.create(name: "Research", teacher: snape , student: ron)
...
charms1 = Assignment.create(name: "Summoning Charms", teacher: filius, student: hermione)
...
planets1 = Assignment.create(name: "Planetary Chart", teacher: sybill, student: hermione)
planets2 = Assignment.create(name: "Planetary Chart", teacher: sybill, student: harry)
planets3 = Assignment.create(name: "Planetary Chart", teacher: sybill, student: ron)

shrubs1 = Assignment.create(name: "Self-Fertilising Shrubs", teacher: pomona, student: hermione)
...
moonstone2 = Assignment.create(name: "Moonstone", teacher: snape, student: hermione)
